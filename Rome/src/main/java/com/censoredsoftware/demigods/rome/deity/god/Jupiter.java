package com.censoredsoftware.demigods.rome.deity.god;
...
{
	public final static String name = "Jupiter", shortDescription = ChatColor.GRAY + "The God of the sky.";
	public final static Alliance alliance = RomanAlliance.GOD;
	...
	public final static List<String> lore = new ArrayList<String>(9 + claimItems.size())
	{
		{
			add(" ");
			add(ChatColor.RED + " Demigods Rome > " + ChatColor.RESET + color + name);
			add(ChatColor.RESET + "-----------------------------------------------------");
			add(" ");
