...
public class Configs {
    ...
    public static String getSettingString(String id) {
        if (DemigodsPlugin.getInst().getConfig().isString(id))
            return DemigodsPlugin.getInst().getConfig().getString(id);
        else return null;
    }
    ...
    public static float getSettingFloat(String id) {
        ...
        if (DemigodsPlugin.getInst().getConfig().isString(id))
            floatValue = DemigodsPlugin.getInst().getConfig().getString(id);
        try {
    ...
    public static double getSettingDouble(String id) {
        if (DemigodsPlugin.getInst().getConfig().isDouble(id))
            return DemigodsPlugin.getInst().getConfig().getDouble(id);
        else return -1;
    }
    ...
    public static List<String> getSettingList(String id) {
        if (DemigodsPlugin.getInst().getConfig().isList(id))
            return DemigodsPlugin.getInst().getConfig().getStringList(id);
        return null;
    }
