...
public class DemigodsLocation extends DataAccess<UUID, DemigodsLocation>
{
	private UUID id;
	...
	DemigodsLocation(UUID id, ConfigurationSection conf)
	{
		this.id = id;
	...
	{
		return DemigodsRegion.at(toLocation());
	}
	...
	private static final DataAccess<UUID, DemigodsLocation> DATA_ACCESS = new DemigodsLocation();
	...
	public static Collection<DemigodsLocation> all()
	{
	...
	public static DemigodsLocation of(String world, double X, double Y, double Z, float yaw, float pitch)
	{
		...
		return Iterables.find(all(), new Predicate<DemigodsLocation>()
		{
			@Override
