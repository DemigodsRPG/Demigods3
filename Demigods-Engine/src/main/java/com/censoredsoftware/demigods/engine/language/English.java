...
public enum English
{
	ADMINISTRATION_STRUCTURE_WAND_ENABLED(new ArrayList<String>()
	{
		{
			...
			add(ChatColor.GRAY + "  the chat and type " + ChatColor.YELLOW + "continue" + ChatColor.GRAY + ".");
		}
