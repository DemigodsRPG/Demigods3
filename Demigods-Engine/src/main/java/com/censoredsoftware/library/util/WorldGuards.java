...
public class WorldGuards implements Listener
{
	...
	static
	{
		...
		if(DemigodsPlugin.getInst().isEnabled()) Bukkit.getScheduler().scheduleAsyncDelayedTask(DemigodsPlugin.getInst(), new Runnable()
		{
			@Override
			public void run()
			{
		...
		if(DemigodsPlugin.getInst().isEnabled()) Bukkit.getScheduler().scheduleAsyncRepeatingTask(DemigodsPlugin.getInst(), new Runnable()
		{
			@Override
			public void run()
			{
