...
public class DemigodsUtil
{
	...
	public static Location randomLocation(Location reference, int min, int max)
	{
		...
		double randX = DemigodsUtil.generateIntRange(min, max);
		double randZ = DemigodsUtil.generateIntRange(min, max);
	...
	{
		Location reference = chunk.getBlock(DemigodsUtil.generateIntRange(1, 16), 64, DemigodsUtil.generateIntRange(1, 16)).getLocation();
