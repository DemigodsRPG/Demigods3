...
public class DebugListener implements Listener
{
	...
	public void onChestSpawn(ChestSpawnEvent event)
	{
		...
		// Send debug
		AdminUlility.sendDebug(ChatColor.RED + "Chest generated at " + ChatColor.GRAY + "(" + location.getWorld().getName() + ") " + location.getX() + ", " + location.getY() + ", " + location.getZ());
	}
	...
	public void onAltarCreation(AltarCreateEvent event)
	{
		...
		// Send debug
		AdminUlility.sendDebug(ChatColor.RED + "Altar generated by " + cause.toString() + " at " + ChatColor.GRAY + "(" + location.getWorld().getName() + ") " + location.getX() + ", " + location.getY() + ", " + location.getZ());
	}
	...
	public void onAltarRemove(AltarRemoveEvent event)
	{
		...
		// Send debug
		AdminUlility.sendDebug(ChatColor.RED + "Altar at " + ChatColor.GRAY + "(" + location.getWorld().getName() + ") " + location.getX() + ", " + location.getY() + ", " + location.getZ() + " removed by " + cause.toString() + ".");
	}
	...
	public void onShrineCreation(ShrineCreateEvent event)
	{
		...
		// Send debug
		AdminUlility.sendDebug(ChatColor.RED + "Shrine created by " + owner.getName() + " (" + owner.getDeity() + ") at: " + ChatColor.GRAY + "(" + location.getWorld().getName() + ") " + location.getX() + ", " + location.getY() + ", " + location.getZ());
	}
	...
	public void onShrineRemove(ShrineRemoveEvent event)
	{
		...
		// Send debug
		AdminUlility.sendDebug(ChatColor.RED + "Shrine at (" + owner.getDeity() + ") at: " + ChatColor.GRAY + "(" + location.getWorld().getName() + ") " + location.getX() + ", " + location.getY() + ", " + location.getZ() + " removed.");
	}
}
