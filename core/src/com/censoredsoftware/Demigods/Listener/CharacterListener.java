...
public class CharacterListener implements Listener
{
	...
	public void onCharacterCreation(CharacterCreateEvent event)
	{
		...
		PlayerCharacterClass character = CharacterAPI.create(player, chosenName, chosenDeity);
	...
	{
		PlayerCharacterClass attacker = event.getCharacter();
		PlayerCharacterClass killed = event.getKilled();
