...
public class Tutorial extends Task.List
{
	...
	public static class Task extends com.censoredsoftware.demigods.task.Task
	{
		...
		private static final Listener listener = new Listener()
		{
			...
			private void onPlayerJoin(PlayerJoinEvent event)
			{
				...
				Demigods.message.tagged(player, "Welcome to demigods, " + character.getDeity().getColor() + character.getName() + ChatColor.RESET + "!");
		...
		{
			super(name, quest, permission, order, reward, penalty, about, accepted, complete, failed, type, Subtype.QUEST, listener);
		}
	}
}
