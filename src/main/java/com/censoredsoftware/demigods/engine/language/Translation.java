...
public class Translation
{
	...
	public static class File extends ConfigFile
	{
		...
		public File(String translation)
		{
			...
			LANGUAGE_PATH = Demigods.plugin.getDataFolder() + "/lang/" + TRANSLATION_FILE;
		}
	...
	public static enum Text
	{
		...
		}), KNELT_FOR_PRAYER("{player} has knelt to begin prayer."), PVP_NO_PRAYER(new ArrayList<String>()
		{
			{
