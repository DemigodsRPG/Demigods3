		...
		public String getText(Enum text)
		{
			...
			switch((Text) text)
			{
				...
				case SUCCESS_ABILITY_BOUND:
					return "{ability} has been bound to your {material}!";
				case ERROR_BIND_TO_AIR:
					return "You can't bind an ability to air.";
