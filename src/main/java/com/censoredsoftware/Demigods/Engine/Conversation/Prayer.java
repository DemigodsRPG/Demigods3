...
public class Prayer {
    ...
    public enum Category {
        CREATE_CHARACTER(1, ChatColor.GREEN + "Create Character", new CreateCharacter()),
        VIEW_CHARACTERS(2, ChatColor.YELLOW + "View Characters", null),
        VIEW_WARPS(3, ChatColor.BLUE + "View Warps", null),
        VIEW_INVITES(4, "View Invites", null);
